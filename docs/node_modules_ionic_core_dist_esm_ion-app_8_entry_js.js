...
const App = class {
  ...
  componentDidLoad() {
    ...
    {
      rIC( /*#__PURE__*/(0,C_Users_flavio_silva_Desktop_Projetos_portfolio_Flavio_Lucas_github_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
const Footer = class {
  constructor(hostRef) {
    ...
    this.setupFadeFooter = /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_flavio_silva_Desktop_Projetos_portfolio_Flavio_Lucas_github_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl) {
        if (!contentEl) {
...
const Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref3 = (0,C_Users_flavio_silva_Desktop_Projetos_portfolio_Flavio_Lucas_github_io_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        if (!contentEl) {
